...
namespace CMS.Core.Migrations
{
    ...
    [Migration("20200922101615_dateaddedinmenu")]
    partial class dateaddedinmenu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMS.Core.Entity.Menu", b =>
                {
                    b.Property<long>("menu_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<long?>("MenuTypemenu_type_id");

                    b.Property<string>("description")
                        .IsRequired()
                        .HasMaxLength(2000);

                    b.Property<decimal>("fake_price");
                    ...
                    b.Property<long>("menu_category_id");

                    b.Property<DateTime>("menu_date");
                    ...
                    b.HasIndex("MenuTypemenu_type_id");
            ...
            modelBuilder.Entity("CMS.Core.Entity.MenuCategory", b =>
                {
                    b.Property<long>("menu_category_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("menu_category_id");

                    b.ToTable("menu_category");
                });

            modelBuilder.Entity("CMS.Core.Entity.MenuType", b =>
                {
                    b.Property<long>("menu_type_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CMS.Core.Entity.Order", b =>
                {
            ...
            modelBuilder.Entity("CMS.Core.Entity.OrderDetail", b =>
                {
                    b.Property<long>("order_detail_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CMS.Core.Entity.Menu", b =>
                {
                    b.HasOne("CMS.Core.Entity.MenuType")
                        .WithMany("menu")
                        .HasForeignKey("MenuTypemenu_type_id");

                    b.HasOne("CMS.Core.Entity.MenuCategory", "menu_category")
                        .WithMany()
            ...
            modelBuilder.Entity("CMS.Core.Entity.OrderDetail", b =>
                {
                    b.HasOne("CMS.Core.Entity.Menu", "menu")
                        .WithMany()
                        .HasForeignKey("menu_id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CMS.Core.Entity.Order", "order")
